"""
Task 3: Backtest pairs trading WTI (xyz:CL) vs Brent (xyz:BRENTOIL) trên dữ liệu
đã lấy từ fetch_spread_stats.py (file spread_data.csv).
...
Output: backtest_results_table.md, backtest_results.csv
"""

import pandas as pd
import numpy as np

INPUT_CSV = "spread_data.csv"          # từ fetch_spread_stats.py
ROLLING_WINDOW = 96                    # 96 nến m15 = 1 ngày, dùng làm baseline rolling
...
def main():
    ...
    print("\nSaved -> backtest_results_table.md, backtest_results.csv")
